  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        wipLimit: { type: "number", description: "WIP limit: max tasks one user may have in this column at once before the board header warns. The app applies it to the in_progress column only (positive integer, omit for no limit)" },
      },
      required: ["slug", "name"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        wipLimit: { type: ["number", "null"], description: "Per-user WIP limit (positive integer), applied by the app to the in_progress column only; null removes the limit" },
      },
      required: ["id"],
    },
  },
